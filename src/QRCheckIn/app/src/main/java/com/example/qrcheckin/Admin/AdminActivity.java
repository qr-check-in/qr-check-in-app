...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView addAdminImageView = findViewById(R.id.addAdminImageView);
        TextView addAdminTextView = findViewById(R.id.addAdminTextView);
        ...
        Button eventListButton = findViewById(R.id.btn_admin_event);
        Button profileListButton = findViewById(R.id.profile_admin_button);
        Button imageListButton = findViewById(R.id.image_admin_button);
